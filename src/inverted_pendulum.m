function xdot = inverted_pendulum(x, u)
    ...
    x2_dot = ( ...
                -J2*( ...
                     Ka1*x2 - Kf*x5 ...
                     + x4*(Lcm2*Le1*m2*x4 + 2*J2*x2*cos(x3))*sin(x3) ...
                     )...
                + Lcm2*Le1*m2*cos(x3)* ...
                (-Ka2*x4 + (g*Lcm2*m2+J2*x2^2*cos(x3))*sin(x3)) ...
             )/...
    ...
    x4_dot = ( ...
              Ka2*x4 - g*Lcm2*m2*sin(x3)*(J0+J2*sin(x3)^2)+...
              cos(x3)*( ...
                       (-J0*J2*x2^2 + Lcm2^2*Le1^2*m2^2*x4^2)*sin(x3)-...
                       J2^2*x2^2*sin(x3)^3 + Lcm2*Le1*m2* ...
                       (Ka1*x2 - Kf*x5 + J2*x2*x4*sin(2*x3)) ...
                       ) ...
             )/...
        (Lcm2^2*Le1^2*m2^2*cos(x3)^2 - J2*(J0 + J2*sin(x3)^2));
