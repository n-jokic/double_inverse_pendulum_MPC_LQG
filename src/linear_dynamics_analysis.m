function [A, B, C, D, G, controllable, observable, stable] = ...
    linear_dynamics_analysis(system_dynamics, ...
    x_linearization_point, ...
    u_linearization_point, ....
        observation_model, print_info)
...
[A, B, C, D] = linearize(system_dynamics, x_linearization_point, ...
    u_linearization_point, observation_model);
